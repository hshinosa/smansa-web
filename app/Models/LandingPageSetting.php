    ...
    public static function getDefaults(string $sectionKey): array
    {
        $defaults = [
            ...
            'kepsek_welcome_lp' => [
                ...
                'welcome_text_html' => '<p><strong>Assalamu’alaikum Warahmatullahi Wabarakatuh,</strong><br><strong>Sampurasun!</strong></p><p>Puji dan syukur senantiasa kita panjatkan ke hadirat Allah SWT, Tuhan Yang Maha Esa, atas segala limpahan rahmat dan karunia-Nya. Selamat datang di portal resmi SMA Negeri 1 Baleendah.</p><p>Di era digital dan keterbukaan informasi ini, kami menyadari pentingnya sebuah platform komunikasi yang interaktif dan informatif. Website ini hadir sebagai wujud nyata komitmen kami dalam memberikan layanan pendidikan yang transparan, profesional, dan berorientasi pada kemajuan peserta didik.</p><p>SMA Negeri 1 Baleendah tidak hanya fokus pada pencapaian prestasi akademik, tetapi juga pembentukan karakter, etika, dan nilai-nilai kebangsaan sesuai dengan Profil Pelajar Pancasila. Kami percaya bahwa setiap anak memiliki keunikan dan potensi luar biasa yang siap untuk dikembangkan.</p><p>Semoga website ini dapat menjadi jembatan silaturahmi antara sekolah dengan orang tua, alumni, dan masyarakat luas. Mari bersama-sama kita wujudkan generasi muda yang <strong>"Unggul dalam Prestasi, Berkarakter Mulia"</strong>.</p><p>Wassalamu’alaikum Warahmatullahi Wabarakatuh.</p>',
            ],
            'programs_lp' => [
                'title' => 'Program Studi',
