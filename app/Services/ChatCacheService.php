...
class ChatCacheService
{
    ...
    public function set(string $message, string $response, array $context = []): void
    {
        ...
        try {
            ...
            try {
                Redis::incr($this->prefix.'size');
            } catch (\Exception $e) {
                // Fallback to cache if Redis unavailable
    ...
    public function invalidatePattern(string $pattern): void
    {
        try {
            ...
            // Use atomic Redis operations
            try {
                Redis::decr($this->prefix.'patterns_count');
            } catch (\Exception $e) {
    ...
    protected function evictBatch(): int
    {
        try {
            ...
            if (empty($batch)) {
                ...
                // Use atomic Redis operations
                try {
                    Redis::decr($this->prefix.'batch_count');
                } catch (\Exception $e) {
    ...
    protected function addToBatch(string $key): void
    {
        try {
            ...
            // Use atomic Redis operations
            try {
                Redis::incr($this->prefix.'batch_count');
            } catch (\Exception $e) {
